...
from .fermatapi.views import Symbols, EquationSymbols, Equations, Categories, EquationTexts, register, login_user
...
router.register('equationtext', EquationTexts, 'equationtext')
